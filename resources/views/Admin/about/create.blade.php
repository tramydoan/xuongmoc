        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('quan-tri.about.index')}}"><button type="button" class="btn btn-info"><i class="fas fa-th-list mr-2"></i>Danh sách</button></a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    <div class="col-md-12">
        <form role="form" action="{{route('quan-tri.about.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card  ">
