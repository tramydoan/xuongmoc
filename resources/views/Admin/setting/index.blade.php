                ...
                <div class="col-12">
                    <div class="card">
                        <div class="mb-3 mt-3 d-flex justify-content-between align-items-center col-12">
                            <a href="{{route('quan-tri.setting.create')}}"><button type="button" class="btn btn-info"><i class="fas fa-plus mr-2"></i>Thêm Mới</button></a>

                            <div class="card-tools">
                                <form class="form-inline ml-3" method="GET" action="{{route('admin.setting.search')}}">
